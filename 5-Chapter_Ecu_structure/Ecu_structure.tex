...
\end{itemize}
The interface between the code developed via the model based design approach and the \gls{ECU} hardware there is the \gls{AUTOSAR} standard. This standardize software architecture is the interface that stay in the middle, in between the hardware and the software. 
\section{AUTOSAR}
