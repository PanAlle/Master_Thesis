...
To have a better overview of how the SCM process is structured it is import at to have an overview of the main tools that are used in the process. The components interacts together to create the system big picture. The main components in Software configuration Managements are:
\begin{itemize}
...
%Shape: Rectangle [id:dp8270914998284196] 
\draw   (100,121) -- (200,121) -- (200,170) -- (100,170) -- cycle ;

%Shape: Rectangle [id:dp23417859595674706] 
\draw   (310,121) -- (410,121) -- (410,170) -- (310,170) -- cycle ;
%Shape: Rectangle [id:dp6248554362448269] 
\draw   (240,120) -- (270,120) -- (270,140) -- (240,140) -- cycle ;
%Shape: Rectangle [id:dp27589585736518707] 
\draw   (240,150) -- (270,150) -- (270,170) -- (240,170) -- cycle ;
%Shape: Rectangle [id:dp5883813410946752] 
\draw   (520,121) -- (620,121) -- (620,170) -- (520,170) -- cycle ;
%Shape: Rectangle [id:dp1170019747828861] 
\draw   (450,135) -- (480,135) -- (480,155) -- (450,155) -- cycle ;
%Straight Lines [id:da5130333476058844] 
\draw    (270,160) -- (308,160) ;
\draw [shift={(310,160)}, rotate = 180] [color={rgb, 255:red, 0; green, 0; blue, 0 }  ][line width=0.75]    (6.56,-1.97) .. controls (4.17,-0.84) and (1.99,-0.18) .. (0,0) .. controls (1.99,0.18) and (4.17,0.84) .. (6.56,1.97)   ;
%Straight Lines [id:da20487063638026526] 
\draw    (270,130) -- (308,130) ;
\draw [shift={(310,130)}, rotate = 180] [color={rgb, 255:red, 0; green, 0; blue, 0 }  ][line width=0.75]    (6.56,-1.97) .. controls (4.17,-0.84) and (1.99,-0.18) .. (0,0) .. controls (1.99,0.18) and (4.17,0.84) .. (6.56,1.97)   ;
%Straight Lines [id:da8262218954934673] 
\draw    (200,160) -- (238,160) ;
\draw [shift={(240,160)}, rotate = 180] [color={rgb, 255:red, 0; green, 0; blue, 0 }  ][line width=0.75]    (6.56,-1.97) .. controls (4.17,-0.84) and (1.99,-0.18) .. (0,0) .. controls (1.99,0.18) and (4.17,0.84) .. (6.56,1.97)   ;
%Straight Lines [id:da9837393153591754] 
\draw    (200,130) -- (238,130) ;
\draw [shift={(240,130)}, rotate = 180] [color={rgb, 255:red, 0; green, 0; blue, 0 }  ][line width=0.75]    (6.56,-1.97) .. controls (4.17,-0.84) and (1.99,-0.18) .. (0,0) .. controls (1.99,0.18) and (4.17,0.84) .. (6.56,1.97)   ;
%Straight Lines [id:da1306834064857445] 
\draw    (410,145) -- (448,145) ;
\draw [shift={(450,145)}, rotate = 180] [color={rgb, 255:red, 0; green, 0; blue, 0 }  ][line width=0.75]    (6.56,-1.97) .. controls (4.17,-0.84) and (1.99,-0.18) .. (0,0) .. controls (1.99,0.18) and (4.17,0.84) .. (6.56,1.97)   ;
%Straight Lines [id:da8060002888286144] 
\draw    (480,145) -- (518,145) ;
\draw [shift={(520,145)}, rotate = 180] [color={rgb, 255:red, 0; green, 0; blue, 0 }  ][line width=0.75]    (6.56,-1.97) .. controls (4.17,-0.84) and (1.99,-0.18) .. (0,0) .. controls (1.99,0.18) and (4.17,0.84) .. (6.56,1.97)   ;
%Image [id:dp5269900599421633] 
\draw (255,130.5) node  {\includegraphics[width=10.5pt,height=11.25pt]{images_folder/136443.png}};
%Image [id:dp42456422714657904] 
\draw (256,160.5) node  {\includegraphics[width=10.5pt,height=11.25pt]{images_folder/136443.png}};
%Image [id:dp1481939162507082] 
\draw (466,145.5) node  {\includegraphics[width=10.5pt,height=11.25pt]{images_folder/136443.png}};
%Shape: Rectangle [id:dp8828311525056955] 
\draw   (310,180) -- (410,180) -- (410,229) -- (310,229) -- cycle ;
%Straight Lines [id:da2968573864523689] 
\draw    (255,205) -- (308,205) ;
\draw [shift={(310,205)}, rotate = 180] [color={rgb, 255:red, 0; green, 0; blue, 0 }  ][line width=0.75]    (6.56,-1.97) .. controls (4.17,-0.84) and (1.99,-0.18) .. (0,0) .. controls (1.99,0.18) and (4.17,0.84) .. (6.56,1.97)   ;
%Straight Lines [id:da19902971151232385] 
\draw    (255,170) -- (255,205) ;
%Straight Lines [id:da3830914957967655] 
\draw    (410,206) -- (448,206) ;
\draw [shift={(450,206)}, rotate = 180] [color={rgb, 255:red, 0; green, 0; blue, 0 }  ][line width=0.75]    (6.56,-1.97) .. controls (4.17,-0.84) and (1.99,-0.18) .. (0,0) .. controls (1.99,0.18) and (4.17,0.84) .. (6.56,1.97)   ;
%Image [id:dp7812383507621843] 
\draw (466,206.5) node  {\includegraphics[width=10.5pt,height=11.25pt]{images_folder/136443.png}};
%Shape: Rectangle [id:dp8094421041024371] 
\draw   (450,196) -- (480,196) -- (480,216) -- (450,216) -- cycle ;
%Straight Lines [id:da9112107882737994] 
\draw    (530,206) -- (530,172) ;
\draw [shift={(530,170)}, rotate = 450] [color={rgb, 255:red, 0; green, 0; blue, 0 }  ][line width=0.75]    (6.56,-1.97) .. controls (4.17,-0.84) and (1.99,-0.18) .. (0,0) .. controls (1.99,0.18) and (4.17,0.84) .. (6.56,1.97)   ;
%Straight Lines [id:da3143070711013838] 
\draw    (480,206) -- (530,206) ;
%Shape: Rectangle [id:dp1783948718964936] 
\draw  [color={rgb, 255:red, 155; green, 155; blue, 155 }  ,draw opacity=1 ][dash pattern={on 4.5pt off 4.5pt}][line width=0.75]  (234,110) -- (275,110) -- (275,180) -- (234,180) -- cycle ;
%Shape: Rectangle [id:dp553145583526536] 
\draw  [color={rgb, 255:red, 155; green, 155; blue, 155 }  ,draw opacity=1 ][dash pattern={on 4.5pt off 4.5pt}][line width=0.75]  (445,120) -- (486,120) -- (486,230) -- (445,230) -- cycle ;

% Text Node
\draw (123,136) node [anchor=north west][inner sep=0.75pt]   [align=left] {{\fontfamily{pcr}\selectfont Task 1}};
% Text Node
\draw (333,136) node [anchor=north west][inner sep=0.75pt]   [align=left] {{\fontfamily{pcr}\selectfont Task 2}};
% Text Node
\draw (544,136) node [anchor=north west][inner sep=0.75pt]   [align=left] {{\fontfamily{pcr}\selectfont Task 4}};
% Text Node
\draw (201,114) node [anchor=north west][inner sep=0.75pt]   [align=left] {{\fontfamily{pcr}\selectfont {\tiny O1T1}}};
% Text Node
\draw (201,144) node [anchor=north west][inner sep=0.75pt]   [align=left] {{\fontfamily{pcr}\selectfont {\tiny O2T1}}};
% Text Node
\draw (279,144) node [anchor=north west][inner sep=0.75pt]   [align=left] {{\fontfamily{pcr}\selectfont {\tiny I1T2}}};
% Text Node
\draw (279,114) node [anchor=north west][inner sep=0.75pt]   [align=left] {{\fontfamily{pcr}\selectfont {\tiny I1T2}}};
% Text Node
\draw (412,124) node [anchor=north west][inner sep=0.75pt]   [align=left] {{\fontfamily{pcr}\selectfont {\tiny O1T2}}};
% Text Node
\draw (498,125) node [anchor=north west][inner sep=0.75pt]   [align=left] {{\fontfamily{pcr}\selectfont {\tiny I1T4}}};
% Text Node
\draw (333,196) node [anchor=north west][inner sep=0.75pt]   [align=left] {{\fontfamily{pcr}\selectfont Task 3}};
% Text Node
\draw (281,185) node [anchor=north west][inner sep=0.75pt]   [align=left] {{\fontfamily{pcr}\selectfont {\tiny I1T3}}};
% Text Node
\draw (412,183) node [anchor=north west][inner sep=0.75pt]   [align=left] {{\fontfamily{pcr}\selectfont {\tiny O1T3}}};
% Text Node
\draw (498,185) node [anchor=north west][inner sep=0.75pt]   [align=left] {{\fontfamily{pcr}\selectfont {\tiny I2T4}}};


\end{tikzpicture}
    \centering
    \caption{Build sequential organization}
    \label{fig:squentaility}
\end{figure}
