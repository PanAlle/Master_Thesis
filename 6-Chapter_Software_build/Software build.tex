...
\end{figure}
The build process insert itself in the \gls{SCM} process as the one responsible of modifying the configurations artifacts. Via the build and other auxiliary step the artifact are modified and new are created, requiring therefor all the previously explained \gls{SCM} operations to take place.  Other than that the build the process is the junction point of \gls{SCM} with Agile development.\\
